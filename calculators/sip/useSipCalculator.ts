...
// Re-export the pure calculation function for backward compatibility
export { calculateSipCorpus } from './sipCalculations';

// Import for internal use
import { calculateSipCorpus } from './sipCalculations';
